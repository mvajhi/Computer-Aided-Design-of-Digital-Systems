...
# Pleas add other module here	
	...
	vlog 	+acc -incr -source  +define+SIM 	$hdl_path/not_mod.v
	vlog 	+acc -incr -source  +define+SIM 	$hdl_path/nor_mod.v
	vlog 	+acc -incr -source  +define+SIM 	$hdl_path/xor_mod.v
